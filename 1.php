...
<link rel="stylesheet" href="{{url('')}}/frontend_assets/sass/home/home.css" />
            ...
            <div class="property_grid swiper">
                ...
                <div class="item-md" data-animate="{{ $animations[$index % 2] }}">
                    <a href="{{ route('property.by.subtype', $subtype->slug) }}" class="figure"  rel="noopener noreferrer">
                        <img src="{{ asset('public/uploads/psubtypes/' . $subtype->main_image) }}" alt="{{ $subtype->psubtype_name }}" />
                    </a>
                    <figcaption>
                ...
                <div class="count-info-wrap">
                    <div class="count-info">
                        <div class="upper_wrap">
                            <img src="{{ url('storage/app/public/' . $statistic->icon_path) }}" alt="{{ $statistic->count }}" class="svg" />
                        ...
                        <div class="swiper-slide">
                            <div class="prop_col">
                                <a href="{{ url('property/' . $item->slug) }}"><figure>
                                    ...
                                    <a href="{{ url('property/' . $item->slug) }}" class="exp_pro" target="_blank" rel="noopener noreferrer"> Explore projects <img src="{{url('')}}/frontend_assets/icon/top-right.svg" alt="" /> </a>
                                    @if($item->is_featured)
