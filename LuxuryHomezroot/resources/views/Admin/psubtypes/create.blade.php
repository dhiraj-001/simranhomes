            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add Property Sub Types</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                <li class="breadcrumb-item active">Add Property Sub Types</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Create New Property Sub Type</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('Admin.psubtypes.store') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf


                                <div class="form-group row mb-4">
                                    <label for="heading" class="col-form-label col-lg-2">Property Sub Type Name </label>
                                    <div class="col-lg-10">
                                        <input name="psubtype_name" type="text" class="form-control" id="psubtype_name"
                                            placeholder="Enter Property Sub Types Name ..." required>
                                    </div>
                                </div>
...
document.getElementById('psubtype_name').addEventListener('keyup', function() {
    var headingValue = document.getElementById('psubtype_name').value;
