...
@section('title', 'Admin | Home Page | Slider')
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h5 class="card-title">All Blogs <span
                                                class="text-muted fw-normal ms-2">({{ $blogs->count() }})</span></h5>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                        <div>
                                            <a href="{{ route('Admin.blogs.create') }}" class="btn btn-light"><i
                                ...
                                <table class="table align-middle datatable dt-responsive table-check nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="form-check font-size-16">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="blog{{ $blog->id }}">
                                                    <label class="form-check-label" for="slider{{ $blog->id }}"></label>
                                                </div>
                                            </th>
                                            ...
                                            <td>
                                                @php
                                                $imagePath = str_replace('/storage', '', $blog->main_image);
                                                @endphp
